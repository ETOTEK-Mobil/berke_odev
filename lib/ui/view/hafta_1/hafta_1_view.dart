...
import 'package:odev/ui/view/hafta_1/pages/state_management/state_management_page.dart';
      ...
      body: Center(
        child: Column(
          ...
          children: [
            ...
            ElevatedButton(
              onPressed: () {
                Navigator.push(context, MaterialPageRoute(builder: (context) => const StateManagementPage()));
              },
